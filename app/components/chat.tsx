...
export const ChatWindow: FC<ChatWindowProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col dark:bg-black dark:text-white">
      <Navbar
      ...
      {!selectedUser ? (
        <div className="flex-1 flex flex-col items-center justify-center bg-gray-100 text-center px-4 dark:bg-black dark:text-white">
        ...
        <>
          {/* Chat Header */}
          <div className="border border-gray-400 mt-5 p-2 bg-white flex justify-between items-center gap-4 dark:bg-black dark:text-white dark:border-gray-900">
  {/* Left: User Icon + Name */}
  <div className="flex items-center gap-2">
    ...
    <h1 className="text-xl font-bold text-gray-800 dark:text-white">{selectedUser.name}</h1>
  </div>
  ...
  <div className="flex items-center gap-3 dark:text-white">
    <input
      ...
      className="px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-black dark:bg-white dark:text-black"
    />
    <Button variant="ghost" size="icon" onClick={() => setShowAbout(true)}>
      <Info className="w-6 h-6 text-gray-600 dark:text-white" />
    </Button>
  </div>
</div>
          ...
          {/* Message List */}
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-100 dark:bg-black dark:text-white">
            {filteredMessages.length === 0 ? (
              <div className="text-center text-gray-500 dark:text-white">No messages found ✨</div>
            ) : (
          ...
          {/* Message Input */}
          <div className="p-4 bg-white border-t border-gray-400 flex items-center gap-2 dark:bg-black dark:text-white dark:border-gray-900">
            <input
              type="text"
              ...
              className="flex-1 px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-black dark:bg-white dark:text-black"
            />
